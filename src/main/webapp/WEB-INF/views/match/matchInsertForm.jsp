...
<c:set var="school" value="${pstAdd.SCHOOL}" />
...
// 매치 등록
	function matchConfirm() {
		...
		/* if (form.SUBJECT.value == null || form.ID.value == '') {
			alert("제목을 입력해주세요.")
			form.SUBJECT.focus();
			return false;
		}
	...
	<div style="margin-top: 73px; margin-left: auto; margin-right: auto; width: 1027px; display: flex; flex-direction: row; justify-content: space-between">
		<div style="float: left; width: 66%; padding: 40px;">
			<div style="display: flex; flex-direction: row">
				<div style="overflow: hidden; width: 100px; height: 100px; border: none; border-radius: 12px; margin-top: 22px">
			...
			<!-- 윗단은 멤버 프로필 사진 --> <!-- 프로필 사진도 가져와야 함 -->
				...
				<div style="margin-left: 32px">
					...
					<p style="font-family: Noto Sans KR, sans-serif; margin-top: 5px; font-size: 25px; color: #383C48; line-height: 37px; letter-spacing: -0.2px">
						<input style="font-family: Noto Sans KR, sans-serif; margin-top: 5px; font-size: 20px; color: #383C48; line-height: 1px;"
					...
					<div style="display: flex; flex-wrap: wrap; flex-direction: row; margin-top: 50px; width: 458px">
						<p style="font-size: 15px; font-weight: bolder">○ 이용 가능한 서비스를 선택해 주세요.</p>
					</div>
						<table style="border-spacing: 30px 15px">
							<tr>
			...
			<div style="margin-top: 58px">
				...
				<div style="display: flex; flex-direction: row; align-items: center; margin: 32px 0px;">
					<div style="width: 220px; height: 130px; border-radius: 5px; overflow: hidden; border: 1px solid rgb(235, 235, 235);">
						<div style="width: 220px; height: 130px; filter: blur(1.25px); background-image: url(&quot;images/certificate.png&quot;); background-position: center center; background-repeat: no-repeat; background-size: cover;"></div>
					</div>
					<!-- 윗단에  -->
					<div style="display: flex; flex-direction: column; margin-left: 32px;">
						<p style="font-family: &amp; amp; amp; amp; quot; Noto Sans KR&amp;amp; amp; amp; quot; , sans-serif; font-size: 15px; letter-spacing: -0.2px; line-height: 22px; color: rgb(56, 60, 72);">
							${pstAdd.PSMEM_LICENSE_NAME}</p>
						<p style="font-size: 14px; letter-spacing: -0.2px; line-height: 19px; color: rgb(56, 60, 72); margin-top: 7px;">
							(사) K.S.D 문화교육원</p>
						<!-- 윗단은 자격증 담당 기관 -->
						<p style="font-size: 12px; line-height: 17px; color: rgb(129, 137, 155); margin-top: 32px;">
			...
			<!-- 펫시터 반려동물 -->
			<div style="margin-top: 58px">
				<h2 style="font-weight: 600; font-size: 17px; letter-spacing: 2px; line-height: 25px; color: #393C47; margin-bottom: 20px">
					펫시터님과 함께하는 반려동물</h2>
				<c:forEach var="petMem" items="${pet}" >
					<div style="display: flex; flex-direction: column; border-top: 1px solid rgb(235, 235, 235); padding: 10px 0px; ">
						<div style="display: flex; flex-direction: row; align-items: center;">
							<img width="50" height="50" src="resources/images/ja1.jpg" style="object-fit: cover; border-radius: 50%;">
							<div style="margin-left: 18px;">
								<!-- 글쓴이 -->
								<p style="font-family: &amp; quot; Noto Sans KR&amp;quot; , sans-serif; font-size: 15px; letter-spacing: -0.2px; line-height: 22px; color: rgb(56, 60, 72);">
								이름 : <c:out value="${petMem.NAME}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${petMem.SEX}"/>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${petMem.KIND}"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${petMem.PET_SIZE}"/></p>
								<p style="font-size: 13px; line-height: 19px; color: rgb(76, 80, 86); margin-top: 6px;">나이 : <c:out value="${petMem.AGE}"/> 살
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								 중성화 여부 : <c:out value="${petMem.SEX_CHK}"/></p>
							</div>
						</div>
					</div>
				</c:forEach>
