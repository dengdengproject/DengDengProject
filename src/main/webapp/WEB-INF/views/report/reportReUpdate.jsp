		...
		<div align="center" class="container">
			<div align="left"
				...
				<div class="form-inline" style="margin-bottom: 1em">
					...
					<input type="hidden" id="REPORT_SUBJECT" name="REPORT_SUBJECT" value="${map.REPORT_SUBJECT }"></input>
				</div>

				<div class="form-inline" style="margin-bottom: 1em">
					<label style="font-weight: bold; width: 90px">작성자</label> 관리자
						<input type="hidden" name="REPORT_WRITER" id="REPORT_WRITER" value="관리자"></input>
				...
				<div>
					<textarea rows="20" cols="100" title="내용" id="REPORT_CONTENT" name="REPORT_CONTENT" placeholder="질문의 답변을 입력하세요.">${map.REPORT_CONTENT }</textarea>
				</div>
