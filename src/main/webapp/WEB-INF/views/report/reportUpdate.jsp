		...
		<div align="center" class="container">
			<div align="left"
				...
				<div class="form-inline" style="margin-bottom: 1em">
					<label>
						<select	id="REPORT_HEADER" name="REPORT_HEADER" style="width: 7em" value="${map.REPORT_HEADER }">
					...
					<label style="font-weight: bold; width: 90px">글제목</label>
					<input type="text" id="REPORT_SUBJECT" name="REPORT_SUBJECT" value="${map.REPORT_SUBJECT }" />
				</div>
				...
				<div>
					<textarea rows="20" cols="100" title="내용" id="REPORT_CONTENT" name="REPORT_CONTENT" placeholder="내용을 입력하세요.">${map.REPORT_CONTENT }</textarea>
				</div>
