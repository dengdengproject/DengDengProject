	...
	<div style="height: auto;">
		<div align="center" class="container">
			<div align="left"
				...
				<span style="font-weight: bold">신고하기 답변쓰기</span>
				<hr />
				<div class="form-inline" style="margin-bottom: 1em">
					<label style="width: 90px">말머리</label> ${map.REPORT_HEADER }
					<input type="hidden" name="REPORT_HEADER" id="REPORT_HEADER" value="${map.PEPORT_HEADER }"></input>	
					<label style="width: 90px">글제목</label> [답변] ${map.REPORT_SUBJECT }
				...
				<div class="form-inline" style="margin-bottom: 1em">
					...
					<label style="margin-left: 3em">
						<input type="checkbox" id="REPORT_PRIVATE_CHECK" name="REPORT_PRIVATE_CHECK" value="Y"/>비밀글</label>
				</div>
				
				<!-- <div id="summernote"></div> -->
				<label style="width: 90px">내용</label> [Q&A질문] ${map.REPORT_CONTENT}
				<div>
					<textarea rows="20" cols="100" title="내용" id="REPORT_CONTENT" name="REPORT_CONTENT" placeholder="질문의 답변을 입력하세요.">${REPORT_CONTENT }</textarea>
				</div>
