...
<div style="height: 1200px;">
	...
	<form action="petRegist" id="joinForm" enctype="multipart/form-data"
		...
		<div style="text-align: center;">
			...
			<div>
				<input type="text" placeholder="품종 입력" id="PET_MEM_KIND"
					name="PET_MEM_KIND"
					style="width: 10em; position: relative; right: 13em; bottom: 2em;">
			</div>
			<div>
		...
		<div style="text-align: center;">
			...
			<div>
				<input type="text" placeholder="대형견" id="PET_MEM_SIZE"
					name="PET_MEM_SIZE"
					style="width: 10em; position: relative; right: 13em; bottom: 2em;">
			</div>
		...
		<div style="text-align: center;">
			...
			<div>
				<input type="text" placeholder="숫자만 입력해주세요" id="PET_MEM_WEIGHT"
					name="PET_MEM_WEIGHT"
					style="width: 10em; position: relative; right: 13em; bottom: 2em;">
			</div>
		...
		<div style="text-align: center;">
			<div
				style="position: relative; right: 26em; margin-top: 1em; bottom: 1.5em;">
		...
		<div style="text-align: center;">
			...
			<div>
				<input type="text" placeholder="3살" id="PET_MEM_AGE"
					name="PET_MEM_AGE"
					style="width: 10em; position: relative; right: 13em; bottom: 3.5em;">
			</div>
		</div>
		...
		<div style="text-align: center;">
			...
			<div style="position: relative; right: 14em; bottom: 3em;">
				<label><input type="checkbox" name="PET_MEM_SEX_CHECK"
					value="Y" style="position: relative; right: 20em; bottom: 2em;">예</label>
				&nbsp;&nbsp; <label><input type="checkbox"
					name="PET_MEM_SEX_CHECK" value="N"
					style="position: relative; right: 20em; bottom: 2em;">아니오</label>
			</div>
		</div>
		...
		<div style="text-align: center;">
			...
			<div style="position: relative; right: 15em; bottom: 3.0em;">
				...
				&nbsp;&nbsp; <label><input type="checkbox"
					name="PET_MEM_CASE" value="N"
					style="position: relative; right: 20em; bottom: 2em;">무</label>
			</div>
		...
		<div style="text-align: center; margin-top: 1em">
			...
			<div>
				<input type="text" placeholder="02-000-0000" id="PET_MEM_PHONE"
					name="PET_MEM_PHONE"
		...
		<!-- 회원ID/펫시터ID/펫ID 일단 NULL값으로 넣어두고 추후 회원페이지랑 연결해서 ID값받아올 예정-->
