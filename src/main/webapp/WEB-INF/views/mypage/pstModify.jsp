...
<!--  회원정보 탭 -->
<div style="height: 950px; border-top: solid;">
	...
	<div
		...
		<label><input type="checkbox" name="license" value="yes">
			예 &nbsp &nbsp &nbsp</label> <label><input type="checkbox"
	...
	<div
		...
		<label><input type="checkbox" name="univ" value="yes">
			예 &nbsp &nbsp &nbsp</label> <label><input type="checkbox" name="univ"
			value="no"> 아니오</label>
	</div>
	...
	<div
		...
		<label><input type="checkbox" name="service" value="?">
			픽업가능 &nbsp &nbsp &nbsp</label> <label><input type="checkbox"
			name="service" value="?">대형견 가능</label> <label><input
			type="checkbox" name="service" value="?"> 산책가능 &nbsp &nbsp
			&nbsp</label> <label><input type="checkbox" name="service" value="?">
			기본 케어 가능 &nbsp &nbsp &nbsp</label> <label><input type="checkbox"
			name="service" value="?"> 출퇴근 가능 &nbsp &nbsp &nbsp</label>
	</div>
	...
	<div align="center">
		<div
			style="text-align: center; position: relative; right: 11em; bottom: 17em; margin-top: 1em; width: 11em;">
			<button style="width: 10em; height: 3em"
				onclick="location.href = '' ">수정</button>
		</div>

		<div
			style="text-align: center; position: relative; left: 1em; bottom: 21em; margin-top: 1em; width: 11em;">
			<button style="width: 10em; height: 3em"
				onclick="location.href = 'pst_my_page.html' ">돌아가기</button>
		</div>

		<div
			style="text-align: center; position: relative; left: 13em; bottom: 25em; margin-top: 1em; width: 11em;">
			<button style="width: 10em; height: 3em"
