			...
			<div class="menu-center collapse navbar-collapse"
				...
				<ul class="ttr_menu_items nav navbar-nav ">
					...
					<li class="ttr_menu_items_parent dropdown active "
						...
						href="pst_my_pet.html" class="ttr_menu_items_parent_link_actives"
...
<div style="height: 850px; border-top: solid;">
	<div style="text-align: center; margin-top: 4em">
		<span style="font-size: 2em; font-weight: bold;">댕댕이 신규 등록</span>
	...
	<div align="center">
		...
		<div align="center">
			<div
				...
				<button style="width: 13em; height: 3em">등록 완료</button>
			</div>
