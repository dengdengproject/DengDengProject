	...
	<div style="height: auto;">
		<div class="wrapper">
					...
					<c:forEach var="board" items="${boardList }">
						<tr>
							...
							<td align="left" class="subject">
								...
								<a href="view.do?idx=${board.idx}">펫시터 결제관련 질문있어요~</a>
							</td>
			...
			<br /> <input type="button" value="목록"
				...
				onclick="location.href='Q&A.html'" /> <input type="button"
				value="쓰기"
				style="width: 7em; position: relative; left: 30em; margin-bottom: 1em; margin-right: 5em;"
				onclick="location.href='Q&AWrite.html'" />
		</div>
	</div>
</div>
