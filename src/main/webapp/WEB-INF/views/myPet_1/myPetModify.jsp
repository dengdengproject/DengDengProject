		...
		<div align="center" class="container">
			<div align="left"
				...
				<div class="form-inline" style="margin-bottom: 1em">
					<label style="font-weight: bold; width: 90px">글제목</label> <input type="text" id="MYPET_SUBJECT" name="MYPET_SUBJECT" value="${map.MYPET_SUBJECT }"/> <!--  ${map.NOTICE_SUBJECT }-->
				...
				<div class="form-inline" style="margin-bottom: 1em">
					<label style="font-weight: bold; width: 90px">글번호</label> ${map.MYPET_NO }<input type="hidden" id="MYPET_NO" name="MYPET_NO" value="${map.MYPET_NO }" />
