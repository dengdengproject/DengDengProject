		...
		<div align="center" class="container">
			<div align="left"
				...
				<div class="form-inline" style="margin-bottom: 1em">
					<label>
						<select	id="QNA_HEADER" name="QNA_HEADER" style="width: 7em" value="${map.QNA_HEADER }">
					...
					<input type="text" id="QNA_SUBJECT" name="QNA_SUBJECT" value="${map.QNA_SUBJECT }" />
				</div>
				...
				<div>
					<textarea rows="20" cols="100" title="내용" id="QNA_CONTENT" name="QNA_CONTENT" placeholder="내용을 입력하세요.">${map.QNA_CONTENT }</textarea>
				</div>
