...
public class JoinServiceImpl implements JoinService {
	...
	@Override
	public void insertMember(Map<String, Object> map) throws Exception { // TODO Auto-generated method stub
	...
	public void insertPst(Map<String, Object> map, HttpServletRequest request) throws Exception {
		...
		System.out.println("-------------insertMember()실행중 이미지 업로드----------------");
	...
	public void insertPstAdd(Map<String, Object> map, HttpServletRequest request) throws Exception {
		...
		Iterator<String> iterator = multipartHttpServletRequest.getFileNames();
		MultipartFile multipartFile = null;
		System.out.println("-------------insertPstAdd()실행중 이미지 업로드----------------");
		while (iterator.hasNext()) {
			multipartFile = multipartHttpServletRequest.getFile(iterator.next());
			if (multipartFile.isEmpty() == false) {
				log.debug("------------- file start -------------");
